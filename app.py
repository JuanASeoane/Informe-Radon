...
def get_supabase_connection():
    """Obtiene la conexión a Supabase usando st.connection."""
...
def verificar_conexion_supabase():
    ...
    try:
        ...
        if conn:
            ...
            st.success(f"✅ Conectado a Supabase")
            return True
        return False
    except Exception as e:
        st.error(f"❌ Error conectando a Supabase: {e}")
            ...
            try:
                ...
                if not existing.data:
                    conn.table("detectores").insert({
                        ...
                        "sala": det[3],
                        "fecha": det[4],
                        "detector_codigo": det[5],
                        "plano_path": det[6],
                        "punto_x": det[7],
                        "punto_y": det[8],
                        "foto_situacion_path": det[9],
                        "foto_detector_path": det[10],
                        "fecha_creacion": det[11],
